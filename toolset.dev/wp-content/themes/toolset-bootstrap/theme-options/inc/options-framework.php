...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Theme Options', 'wpbootstrap'), __('Theme Options', 'wpbootstrap'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_load_styles() {
	...
	//Admin RTL implementation for Bootstrap theme
	//RTL implementation for backend
	
	if ( is_rtl() ) {
		 
		wp_register_style('wpbootstrap-main-rtl-admin', get_template_directory_uri() . '/theme-options/bootstrap-grid/css/bootstrap_rtl_admin.css', array('color-picker'), null);
		wp_enqueue_style('wpbootstrap-main-rtl-admin');
	}	
}	
