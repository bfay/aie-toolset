 ...
 * $LastChangedDate: 2014-07-24 04:32:16 +0000 (Thu, 24 Jul 2014) $
 * $LastChangedRevision: 25255 $
 * $LastChangedBy: bruce $
 *
 */
...
class WPToolset_Types
{
    ...
    public static function filterConditional($field, $post_id)
    {
        ...
        if ( !empty( $field['data']['conditional_display']['custom_use'] ) ) {
            ...
            $cond = self::getCustomConditional($custom, $suffix);
    ...
    public static function getCustomConditional($custom, $suffix = '') {
