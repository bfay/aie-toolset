...
window.ToolsetParser=window.ToolsetParser || 
    ...
    (function(window){
        ...
        var Tokenizer = (function(DateParser){
            ...
            _lstFuncOps  = ["AVG","ABS","ACOS","ARRAY","ASC","ASIN","ATAN","CHR","CONTAINS","COOKIE","COS","DATE","FIX","HEX","IIF","LCASE","LEN","LEFT","LOG","MAX","MID","MIN","NUM","RAND","REGEX","RIGHT","ROUND","SIN","SQRT","STR","TAN","TODAY","UCASE","USER"],
